...
<head>
    ...
    <title>Yan Yan Earth Floral House</title>
...
<body>
    ...
    <div class="best-sellers">
        ...
        <div class="best-seller">
            <a href="peonies.php"><img src="../img/best-seller4.webp"
                    alt="Bouquet Builders Romance Iris Collection"></a>
            <div class="heart"><i class="fa-regular fa-heart fav"></i></div>
    ...
    <div class="history">
        <div class="history-content">
            ...
            <p>All plants from our online plant nursery are backed by Spring Hill's No-Risk Guarantee so you can order
                nursery plants with complete confidence.</p>
        </div>
        <div class="history-content">
