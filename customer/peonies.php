                ...
                <div class="col-3">
                    <div class="card">
                        ...
                        <div class="card-body" style="background-color: #f8f9fa;">
                            ...
                            <p class="card-text mb-3" style="font-size: 1.25rem; font-weight: bold; color: #28a745;">MMK
                                <?= $product['price'] ?></p>
                            ...
                            <form action="add-to-cart.php" method="post" class="d-flex justify-content-between mt-2">
                                <a href="productview.php?id=<?= $product['product_id']?>"
                                    class="btn btn-primary float-right">View Product</a>
